    ...
    {[
      ...
      >
        ...
        >
          ...
          <p className='text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-6'>Let’s create meaningful digital experiences that make a difference. I’m open to new collaborations and challenges.</p>

          <div className='font-semibold text-sm lg:text-xl flex flex-col mt-6 gap-2 lg:gap-4'>
            <motion.a
              whileHover={{ x: 5 }}
              className='flex items-center gap-2 group'
              href="mailto:ruwanpathiranatc@gmail.com"
            >
              <span className='border-2 transition-all border-transparent group-hover:border-black rounded-full p-1'>
                <IoMdMail className="w-4 h-4 lg:w-5 lg:h-5" />
              </span>
              ruwanpathiranatc@gmail.com
            </motion.a>
